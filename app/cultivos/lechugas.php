...
$salesCultivoLechugas = [
  'Nitrato de Calcio' => 1.2,
  'Nitrato de Potasio'=> 0.28,
  'Fosfato Mono Amónico'=> 0.15,
  'Sulfato de Magnesio'=> 0.5,
  'Clorato de Potasio' => 0.2
];
...
foreach ($salesCultivoLechugas as $sal => $valor) {
